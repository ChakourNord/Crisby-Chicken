...
{
  // default connection
  public static $dbname = "workerdb"; // Your database name
  public static $dbuser = "blackstar"; // Your database username
  public static $dbpass = "Mim922145?"; // // Your database password
  public static $dbhost = "192.168.178.46"; // Your database host, 'localhost' is default.
  public static $dbport = "3306"; // Your database host, 'localhost' is default.
  ...
  public static $limit_list = ["25", "50", "100", "all"]; // default limits list
  ...
  public static $available_date_ranges = [
  ...
  public static $search_pattern = ["%", "%"]; // uses for LIKE operator in SQL request
  ...
  public static $xss_disalowed_attibutes = [
    "on\w*",
    /*'style',*/ "xmlns",
    "formaction",
