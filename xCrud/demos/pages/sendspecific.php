...
$subject = "Registered Successfully";
				...
				$emailBody = "Thank you for registering on the ALHP System App,  <br>
				           We have sent your application to the admin for approval. <br> 
				           Once its approved we will send you an email with credentials to login <br> <br> 
