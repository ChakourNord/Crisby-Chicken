...
?>
<div class="xcrud-top-actions btn-group" id="save-btn-kwwwsd-ifr">
    <?php
    ...
    ?>
    <script>
      //on click on save toast massage
    $('.task-com').on("click", function() {
        setTimeout(
            Xcrud.show_message('.xcrud-ajax', 'Companie has been updated', 'info'), 2000);
