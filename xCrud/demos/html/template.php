...
<html>
    <head>
        ...
        -->
        <?php }elseif($theme == 'bootstrap5'){ ?>
        <!--
        <link href="../xcrud/plugins/bootstrap-5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
        <link href="../xcrud/plugins/Font-Awesome-fa-4/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
        -->  
        ...
        <?php }elseif($theme == 'minimal'){ ?>
            <!--<link href="../xcrud/plugins/bootstrap-4.5.0/dist/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
            <link href="../xcrud/plugins/bootstrap-4.5.0/dist/js/bootstrap.min.js" rel="stylesheet" type="text/css" />
            <link href="../xcrud/plugins/tabulator-master/dist/css/tabulator_simple.css" rel="stylesheet" type="text/css" />-->
        <?php } ?>
    ...
    <body>
        ...
        <span class="mobile-btn" onclick="toggleMenu();"> <img src="assets/responsive-icon.png"></span>
            <div id="menu" class="topnav-responsive"><?php include(dirname(__FILE__).'/menu.php') ?></div>
            <div id="content">
                <!--<div class="clr">&nbsp;</div>-->
        ...
        <?php }elseif($theme == 'bootstrap5'){ ?>
           ...
           <!--<script src="../xcrud/plugins/popper-core-master/popper.min.js" ></script>
           <script src="../xcrud/plugins/bootstrap-5.0.2/dist/js/bootstrap.min.js" type="text/javascript"></script>
           -->
        <?php }elseif($theme == 'default'){ ?>
