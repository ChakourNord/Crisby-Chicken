...
<div class="row" style="margin: 0!important;overflow-x: scroll;">
    ...
    <div
        class="xcrud-list-container <?php if($this ->is_edit_side){ echo 'col-sm-12'; } if($this->advanced_search_position == "left" && $this->advanced_search_opened == true){ echo 'col-sm-9'; } ?>">
