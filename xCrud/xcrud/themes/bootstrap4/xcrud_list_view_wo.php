...
<div class="xcrud-top-actions">
    ...
    <div class="btn-group pull-right">
        ...
        <?php if ($this->advanced_search_active == true) { ?>
    ...
    <?php echo $this->add_button("btn btn-success add", "fa fa-plus"); ?>
    <div class="clearfix"></div>
</div>
<?php } ?>

<?php if ($this->advanced_search_position == "top") {
  echo $this->render_advanced_filter();
} ?>

<div class="row" style="margin: 0!important;">

    <?php if ($this->advanced_search_position == "left") {
      echo "<div class='col-sm-3'>";
      echo $this->render_advanced_filter();
      echo "</div>";
    } ?>

    <div class="xcrud-list-container <?php
    if ($this->is_edit_side) {
      echo "col-sm-12";
    }
    if (
      $this->advanced_search_position == "left" &&
      $this->advanced_search_opened == true
    ) {
      echo "col-sm-9";
    }
    ?>">
